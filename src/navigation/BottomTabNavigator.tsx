...
export function BottomTabNavigator({ professorName, onLogout }: BottomTabNavigatorProps) {
  return (
    <Tab.Navigator
      screenOptions={{
        tabBarStyle: {
    ...
    >
      ...
      >
        {(props) => <HomeDashboard {...props} professorName={professorName} onLogout={onLogout} />}
      </Tab.Screen>
      <Tab.Screen
        name="Schedule"
